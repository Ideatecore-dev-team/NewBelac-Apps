...
const Homepage = () => {
    ...
    const criteria = [
        {
            title: "Rhythm & Melody",
            description: "The unique and intricate song patterns of each bird."
        },
        {
            title: "Vocal Quality",
            description: "Clarity, tone, and power of the bird's chirping."
        },
        {
            title: "Chirp Duration",
            description: "The length and consistency of the bird's performance."
        },
        {
            title: "Physical Grace",
            description: "The unique and captivating style of the bird's posture and movement."
        },
    ];

    return (
        <div className="flex flex-col items-center justify-center min-h-screen text-center px-4 md:px-8 lg:px-16 w-[1240px] relative overflow-hidden">
            {/* Animasi Ikon Burung */}
            <div className="absolute top-0 left-0 w-full h-full z-[-1] animate-fly">
                {/* Anda bisa ganti dengan ikon SVG burung atau tag <img> */}
