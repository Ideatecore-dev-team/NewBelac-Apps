        ...
        <div className='fixed top-[242px] left-0 bottom-0 right-0 z-50 flex items-center justify-center bg-black bg-opacity-60 backdrop-blur-[5px]'>
            <div className='profileModalComponents flex w-[400px] p-[16px] flex-col items-start rounded-[6px] border border-[#2C2C2C] bg-[#1C1C1C] gap-[20px]'>
                <div className='container flex justify-between items-center self-stretch mb-4'>
                    <p className="text-white text-[24px] font-semibold leading-4 tracking-[0.5px] font-['D-DIN-PRO'] uppercase"> Edit Profile </p>
                ...
                <div className='menus-container flex-row flex gap-[12px]'>
                    ...
                    <div className='menus-button flex h-[40px] py-[8px] px-[6px] items-center gap-[6px]'>
                        ...
                        <div className='text-container flex justify-center items-center'>
                            <p className="text-white text-[14px] font-semibold leading-4 tracking-[0.5px] font-['D-DIN-PRO']"> Edit Profile Picture </p>
                        </div>
                    </div>
                </div>
                <div className='edit-username flex flex-col items-start gap-2 self-stretch'>
                    <p className="text-white text-[16px] font-semibold leading-4 tracking-[0.5px] font-['D-DIN-PRO'] self-stretch"> Username </p>
                    <div className='field flex h-[48px] py-[12px] px-[16px] items-center gap-2 self-stretch rounded-[6px] border border-[#2C2C2C] bg-black/45'>
                        <input className="text-white/70 text-[16px] font-[500] leading-4 tracking-[0.5px] font-['D-DIN-PRO'] self-stretch grow shrink-0 basis-0 bg-transparent outline-none" value={address || ''} readOnly />
                    ...
                    <p className="text-white/70 text-[16px] font-[500] leading-4 tracking-[0.5px] font-['D-DIN-PRO'] self-stretch h-[22px]"> This is Your wallet address </p>
                </div>
                <div className='edit-email flex flex-col items-start gap-2 self-stretch'>
                    <p className="text-white text-[16px] font-semibold leading-4 tracking-[0.5px] font-['D-DIN-PRO'] self-stretch"> Email Address </p>
                    <div className='field flex h-[48px] py-[12px] px-[16px] items-center gap-2 self-stretch rounded-[6px] border border-[#2C2C2C] bg-black/45'>
                        <input type="email" className="text-white/70 text-[16px] font-[500] leading-4 tracking-[0.5px] font-['D-DIN-PRO'] self-stretch grow shrink-0 basis-0 bg-transparent outline-none" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="your@email.com" />
                    </div>
                </div>
            </div>
        </div>
